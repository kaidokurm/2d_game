package ee.kaido.game.entities;
...
import static ee.kaido.game.utilz.Constants.ANI_SPEED;
import static ee.kaido.game.utilz.Constants.Directions.*;
import static ee.kaido.game.utilz.Constants.GRAVITY;
import static ee.kaido.game.utilz.Constants.PlayerConstants.*;
import static ee.kaido.game.utilz.HelpMethods.*;
...
public class Player extends Entity {
    ...
    private int statusBarWidth = (int) (192 *
            SCALE);
    private int statusBarHeight = (int) (58 *
            SCALE);
    ...
    private int powerBarWidth = (int) (104 *
            SCALE);
    private int powerBarHeight = (int) (2 *
            SCALE);
    private int powerBarXStart = (int) (44 *
            SCALE);
    private int powerBarYStart = (int) (34 *
            SCALE);
    ...
    private void initAttackBox() {
        attackBox = new Rectangle2D.Float(x, y, (int) (35 *
                SCALE), (int) (20 *
                SCALE));
        resetAttackBox();
    }
    ...
    private void setAttackBoxOnRightSide() {
        attackBox.x = hitbox.x + hitbox.width - (int) (
                SCALE * 5);
    }
