...
import static ee.kaido.game.utilz.Constants.Projectiles.CANNON_BALL_HEIGHT;
import static ee.kaido.game.utilz.Constants.Projectiles.CANNON_BALL_WIDTH;
import static ee.kaido.game.utilz.HelpMethods.CanCannonSeePlayer;
import static ee.kaido.game.utilz.HelpMethods.IsProjectileHittingLevel;
...
public class ObjectManager {
    ...
    private void drawGrass(Graphics g, int xLvlOffset) {
        for (Grass grass : currentLevel.getGrass())
            g.drawImage(grassImgs[grass.getType()], grass.getX() - xLvlOffset, grass.getY(), (int) (32 * SCALE), (int) (32 * SCALE), null);
    }
