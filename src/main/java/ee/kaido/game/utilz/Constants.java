...
public class Constants {
    ...
    public static class ObjectConstants {
        ...
        public static int GetTreeOffsetX(int treeType) {
            switch (treeType) {
                case TREE_ONE:
                    return (TILES_SIZE / 2) - (GetTreeWidth(treeType) / 2);
                case TREE_TWO:
                    return (int) (TILES_SIZE / 2.5f);
                case TREE_THREE:
                    return (int) (TILES_SIZE / 1.65f);
            }
        ...
        public static int GetTreeOffsetY(int treeType) {
            ...
            switch (treeType) {
                case TREE_ONE:
                    return -GetTreeHeight(treeType) + TILES_SIZE * 2;
                case TREE_TWO, TREE_THREE:
                    return -GetTreeHeight(treeType) + (int) (TILES_SIZE / 1.25f);
            }
            return 0;
    ...
    public static class EnemyConstants {
        ...
        public static final int PINKSTAR_DRAWOFFSET_X = (int) (9 * SCALE);
        public static final int PINKSTAR_DRAWOFFSET_Y = (int) (7 * SCALE);
